...
const configurePassport = () => {
    ...
    try {
        passport.use(new GoogleStrategy({
            ...
            callbackURL: process.env.GOOGLE_CALLBACK_URL || `${process.env.BASE_URL || (process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'https://shopping-cart-prod.vercel.app')}/auth/google/callback`
